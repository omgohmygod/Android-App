...
public class AddContact extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mSpinner.setAdapter(ArrayAdapter.createFromResource(Objects.requireNonNull(getActivity()),R.array.phonetype,android.R.layout.simple_spinner_dropdown_item));
    }
